...
static app_index_entry_t app_index[] = {
    { "terminal",         "Terminal",         "terminal.elf",         "/icons/terminal.bmp",         0 },
    { "file_explorer",    "File Explorer",    "file_manager.elf",    "/icons/file_explorer.bmp",    0 },
    { "browser",          "Privacy Browser",  "browser.elf",         "/icons/browser.bmp",         0 },
    { "system_monitor",   "System Monitor",   "sys_monitor.elf",      "/icons/system_monitor.bmp",   0 },
    { "image_viewer",     "Image Viewer",     "image_viewer.elf",     "/icons/image_viewer.bmp",     0 },
    { "font_viewer",      "Font Viewer",      "font_viewer.elf",      "/icons/font_viewer.bmp",      0 },
    { "memory_viewer",    "Memory Viewer",    "memory_viewer.elf",    "/icons/memory_viewer.bmp",    0 },
    { "calculator",       "Calculator",       "calculator.elf",       "/icons/calculator.bmp",       0 },
    { "text_editor",      "Text Editor",      "text_editor.elf",      "/icons/text_editor.bmp",      0 },
    { "paint",            "Paint",            "paint.elf",            "/icons/paint.bmp",            0 },
    { "process_monitor",  "Process Monitor",  "process_monitor.elf",  "/icons/process_monitor.bmp",  0 },
    { "hex_viewer",       "Hex Viewer",       "hex_viewer.elf",       "/icons/hex_viewer.bmp",       0 },
    { "snake",            "Snake",            "snake.elf",            "/icons/snake.bmp",            0 },
    { "tetris",           "Tetris",           "tetris.elf",           "/icons/tetris.bmp",           0 },
    { "2048",             "2048",             "2048.elf",             "",                            0 },
    { "pong",             "Pong",             "pong.elf",             "/icons/pong.bmp",             0 },
    { "matrix_rain",      "Matrix Rain",      "matrix_rain.elf",      "/icons/matrix_rain.bmp",      0 },
    { "mandelbrot",       "Mandelbrot",       "mandelbrot.elf",       "/icons/mandelbrot.bmp",       0 },
    { "clock",            "Clock",            "clock.elf",            "/icons/clock.bmp",            0 },
    { "reminders",        "Reminders",        "reminders.elf",        "/icons/reminders.bmp",        0 },
    { "fortune",          "Fortune",          "fortune.elf",          "/icons/fortune.bmp",          0 },
    { "about",            "About",            "about.elf",            "/icons/about.bmp",            0 },
    { "settings",         "Settings",         "settings.elf",         "/icons/settings.bmp",         0 },
    { "file_manager",     "File Manager",     "file_manager.elf",     "/icons/file_explorer.bmp",    0 },
    { "package_manager",  "Package Manager",  "package_manager.elf",  "/icons/package_manager.bmp",  0 },
    { "keyboard_power",   "Keyboard Power",   "keyboard_power.elf",   "/icons/keyboard_power.bmp",   0 },
    { "notepad",          "Notepad",          "notepad.elf",          "/icons/notepad.bmp",          0 },
